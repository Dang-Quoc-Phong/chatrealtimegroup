...
<!-- Mirrored from themes.pixelstrap.com/chitchat/pages/messenger.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Jun 2024 15:10:00 GMT -->
<head>
  <title>Chitchat - Chat Messenger HTML Template</title>
      ...
      <nav class="main-nav on custom-scroll">
        ...
        <div class="sidebar-main">
          <ul class="sidebar-top">
            <li><a class="button-effect" href="status.html" data-tippy-content="status" data-intro="Check Status here">
                <div class="user-popup status one">
                  <div> <img class="bg-img" src="../assets/images/avtar/2.jpg" alt="Avatar"/></div>
                </div></a></li>
            <li><a class="icon-btn btn-light button-effect" href="favourite.html" data-tippy-content="Favourite"><i class="fa fa-star">               </i></a></li>
            <li><a class="icon-btn btn-light button-effect" href="document.html" data-tippy-content="Document"> <i class="fa fa-file-text">       </i></a></li>
            <li><a class="icon-btn btn-light button-effect" href="contact-list.html" data-tippy-content="Contact List"> <i class="fa fa-users">  </i></a></li>
            <li>
              <div class="dot-btn dot-danger grow"><a class="icon-btn btn-light button-effect" href="notification.html" data-tippy-content="Notification"> <i class="fa fa-bell"></i></a></div>
            </li>
            <li><a class="icon-btn btn-light button-effect" href="settings.html" data-tippy-content="Setting" data-intro="You can change settings by clicking here"> <i class="fa fa-cog"></i></a></li>
          </ul>
                ...
                <div class="tab-pane fade show active" id="chat" role="tabpanel" aria-labelledby="chat-tab"> 
                  <div class="theme-tab">       
                    <ul class="nav nav-tabs" id="myTab1" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link button-effect" id="group-tab" data-bs-toggle="tab" href="#group" role="tab" aria-controls="group" aria-selected="true" data-to="group_chat">Group</a>
                      </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContent1">
                      <div class="tab-pane fade show active" id="direct" role="tabpanel" aria-labelledby="direct-tab"> 
                        <ul class="chat-main">
                          {{-- <li data-to="blank">
                            ...
                            <div class="chat-box">
                            <a href="{{route('chatPrivate', $user->id)}}" id="link_{{$user->id}}" class="item">  <div class="profile offline"><img class="bg-img" src="{{$user->image}}" alt="Avatar"/></div></a>
                              <div class="details">
                      ...
                      <div class="tab-pane fade" id="group" role="tabpanel" aria-labelledby="group-tab"> 
                        ...
                        <ul class="group-main">
                          ...
                          <li data-to="group_blank">
                            <div class="group-box">
                              <div class="profile"><img class="bg-img" src="../assets/images/avtar/girls.jpg" alt="Avatar"/></div>
                              <div class="details">
            ...
            <li>
              <div class="chat-box">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right" href="https://themes.pixelstrap.com/chitchat/assets/doc/messenger.html" target="_blank"><i data-feather="download"></i></a></div>
                </div>
              </div>
            </li>
            <li>
              <div class="chat-box">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right" href="https://themes.pixelstrap.com/chitchat/assets/doc/chapter1.MP4" target="_blank"> <i data-feather="download"></i></a></div>
                </div>
              </div>
            </li>
            <li>
              <div class="chat-box">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right" href="https://themes.pixelstrap.com/chitchat/assets/doc/salary.xlsx" target="_blank"> <i data-feather="download"></i></a></div>
                </div>
              </div>
            </li>
            <li>
              <div class="chat-box">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right" href="https://themes.pixelstrap.com/chitchat/assets/doc/document.pdf" target="_blank"> <i data-feather="download"></i></a></div>
                </div>
              </div>
            </li>
            <li>
              <div class="chat-box">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right" href="https://themes.pixelstrap.com/chitchat/assets/doc/details.txt" target="_blank"> <i data-feather="download"></i></a></div>
                </div>
              </div>
            </li>
            <li>
        ...
        <div class="chat-content tabto active">
          <div class="messages custom-scroll active" id="chating">
                ...
                <div class="col-7">
                 ...
                 <div class="d-flex left">
                  <a href="{{route('chatPrivate', $user->id)}}" class="item" id="link_{{$user->id}}">
                   <div class="media-left">
                     <div class="profile online menu-trigger"><img class="bg-img" src="{{$user->image}}" alt="Avatar"/></div>
                   </div>
                  </a>
                   <div class="flex-grow-1">
            ...
            <div class="contact-chat">
              <ul class="chatappend">
                ...
                <li class="replies">
                  <div class="d-flex">
                    <div class="profile"><img class="bg-img" src="../assets/images/avtar/1.jpg" alt="Avatar"/></div>
                    <div class="flex-grow-1">
                      <div class="contact-name">
                        <h5>Alan josheph</h5>
                        <h6>01:40 AM</h6>
                        <ul class="msg-box">
                          ...
                          <li class="msg-setting-main">
                            <div class="document"><i class="fa fa-file-excel-o font-primary"></i>
                              ...
                              <div class="icon-btns"><a class="icon-btn btn-outline-light" href="https://themes.pixelstrap.com/chitchat/assets/doc/Document.xlsx" target="_blank"><i data-feather="download"> </i></a></div>
                            </div>
                        ...
                        <ul class="msg-box">
                          ...
                          <li class="msg-setting-main">
                            ...
                            <div class="refresh-block">
                              <div class="badge badge-outline-primary refresh sm"><i data-feather="rotate-cw"></i></div>
                              <div class="badge badge-danger sm">F</div>
                            </div>
                            <div class="msg-dropdown-main">
                              <div class="msg-setting"><i class="ti-more-alt"></i></div>
                              <div class="msg-dropdown"> 
          ...
          <div class="message-input">
            <div class="wrap emojis-main"><a class="icon-btn btn-outline-primary button-effect toggle-sticker outside" href="#">
              ...
              <button class="submit icon-btn btn-primary " id="send-msg" disabled="disabled"><i data-feather="send"> </i></button>
            ...
            <div class="collapse-block open">
              ...
              <div class="block-content">
                <div class="row share-media zoom-gallery">
                  ...
                  <div class="col-12">
                    <h6 class="mb-2 mt-2">20/04/2023</h6>
                  </div>
                  <div class="col-4">
                    <div class="media-small isotopeSelector filter">
                      <div class="overlay">
              ...
              <div class="block-content">
                <div class="contact-chat p-0 m-0">
                  <ul class="str-msg">
                    <li>
                      <div class="d-flex">
                        <div class="profile me-4"><img class="bg-img" src="../assets/images/contact/2.jpg" alt="Avatar"/></div>
                        <div class="flex-grow-1">
                          <div class="contact-name">
                            <h5>Alan josheph</h5>
                            <h6>01:35 AM</h6>
                    ...
                    <li>
                      <div class="d-flex">
                        <div class="profile me-4"><img class="bg-img" src="../assets/images/contact/3.jpg" alt="Avatar"/></div>
                        <div class="flex-grow-1">
                          <div class="contact-name">
                            <h5>Josephin water</h5>
                            <h6>01:35 AM</h6>
      ...
      <aside class="app-sidebar active">
              ...
              <div class="todo-main">
                <div class="theme-title">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1"><a class="icon-btn btn-sm btn-outline-light close-apps" href="#"><i data-feather="x"></i></a></div>
                  </div>
                </div>
                <div class="todo-name">
              ...
              <div class="file-tab">
                <div class="tab-content custom-scroll">
                  <div class="tab-pane active" id="tab1">
                    <div class="media-gallery portfolio-section grid-portfolio">
                      <div class="collapse-block open">
                        <h5 class="block-title">12/12/2023
                        ...
                        <h5 class="block-title">10/01/2024
                        ...
                        <h5 class="block-title">30/04/2024
                          <label class="badge badge-primary sm ms-2">2</label>
                        </h5>
                        <div class="block-content">                        
                          <div class="row share-media zoom-gallery">
                        ...
                        <div class="block-content">
                          <div class="row share-media zoom-gallery mb-5">
                            <div class="col-4 isotopeSelector filter">
                              <div class="media-big">
                                <div class="overlay">
                                  <div class="border-portfolio"><a href="../assets/images/gallery/1.jpg">
                  ...
                  <div class="tab-pane fade" id="tab2">
                    <div class="link-group">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/12.png" alt="media-img"/>
                        <div class="flex-grow-1">
                    ...
                    <div class="link-group">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/3.png" alt="media-img"/>
                        <div class="flex-grow-1">
                    ...
                    <div class="link-group">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/8.png" alt="media-img"/>
                        <div class="flex-grow-1">
                    ...
                    <div class="link-group">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/9.png" alt="media-img"/>
                        <div class="flex-grow-1">
                          <h5>HTML Template.</h5>
                    ...
                    <div class="link-group">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/11.png" alt="media-img"/>
                        <div class="flex-grow-1">
                    ...
                    <div class="link-group">
                      <div class="d-flex">
                        <div class="d-flex"></div><i data-feather="link"></i>
                        <div class="flex-grow-1">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/10.png" alt="media-img"/>
                        <div class="flex-grow-1">
                    ...
                    <div class="link-group">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/7.png" alt="media-img"/>
                        <div class="flex-grow-1">
                    ...
                    <div class="link-group">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/4.png" alt="media-img"/>
                        <div class="flex-grow-1">
                    ...
                    <div class="link-group">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/6.png" alt="media-img"/>
                        <div class="flex-grow-1">
                    ...
                    <div class="link-group mb-5">
                      ...
                      <div class="d-flex"><img class="img-fluid" src="../assets/images/file_icons/5.png" alt="media-img"/>
                        <div class="flex-grow-1">
            ...
            <li id="notes">
              <div class="notes-main">
                ...
                <div class="notes-list">
                  ...
                  <div class="d-flex"><img class="img-fluid me-3" src="../assets/images/file_icons/5.png" alt="media-img"/>
                    <div class="flex-grow-1">
        ...
        <div class="app-list">
          <ul class="app-list-ul custom-scroll">
            ...
            <li><a class="icon-btn btn-outline-success btn-sm button-effect" href="files.html"><i data-feather="file"></i></a>
              <h5>Files    </h5>
            </li>
            <li><a class="icon-btn btn-outline-primary btn-sm button-effect" href="notes.html"><i data-feather="book"></i></a>
              <h5>Notes    </h5>
            </li>
            <li><a class="icon-btn btn-outline-danger btn-sm button-effect" href="todo.html"><i data-feather="list"></i></a>
              <h5>Todo    </h5>
            </li>
            <li><a class="icon-btn btn-outline-warning btn-sm button-effect" href="reminder.html"><i data-feather="clock"></i></a>
              <h5>Reminder</h5>
            </li>
        ...
        <div class="modal-body">
          <div class="videocall call-modal"><img class="bg-img" src="../assets/images/avtar/big/videocall_bg.jpg" alt="Avatar"/>
            ...
            <div class="d-flex gap-3 videocall-details">
              ...
              <div class="zoomcontent"><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()" data-tippy-content="Zoom Screen"><img src="https://themes.pixelstrap.com/chitchat/assets/images/logo/maximize.svg" alt="zoom screen"/></a></div>
            </div>
            <div class="center-con text-center">
              <ul>
  ...
  <script type="module">
    ...
    .here(users => {
      ...
      elementStatus.classList.add('media-left')
      if(el) {
    ...
    .leaving(user => {
      let el = document.querySelector(`link_${user.id}`)
      let elementStatus = el.querySelector('.media-left')
      if(elementStatus){
        el.removeChild(elementStatus)
      }
    })
    .listen('UserOnlined', event => {
      let blockChat = document.querySelector(".contact-chat")
      let elementChat = document.createElement('li')
      elementChat.textContent = `${event.user.name}: ${event.message}`
      if(event.user.id == "{{Auth::user()->id}}"){
        elementChat.classList.add('msg-setting-main')

      }
      blockChat.appendChild(elementChat)
    })
    let setemoj = document.querySelector("#setemoj")
    let send-msg = document.querySelector("#send-msg")

    send-msg.addEventListener('click', function() {
      axios.post('{{route('sendMessage')}}', {
        'message': setemoj.value
      })
      .then(data =>{
  ...
  @endsection
<!-- Mirrored from themes.pixelstrap.com/chitchat/pages/messenger.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Jun 2024 15:10:32 GMT -->
</html>